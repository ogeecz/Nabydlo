...
const UploadStep: React.FC<UploadStepProps> = ({ onUpload, isLoading, error }) => {
  ...
  return (
    <div className="text-center flex flex-col items-center">
      <h2 className="text-2xl font-semibold mb-2">Krok 1: Nahrajte fotku místnosti, kterou chcete přetvořit</h2>
      <p className="text-gray-400 mb-6">Naše AI analyzuje váš prostor a připraví ho na designovou proměnu.</p>
      ...
      <form id="form-file-upload" onDragEnter={handleDrag} onSubmit={(e) => e.preventDefault()} className="w-full max-w-lg">
        ...
        >
          <div className="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p className="text-xs text-gray-500">PNG nebo JPG (MAX. 10MB)</p>
          </div>
      ...
      <Button onClick={onButtonClick} disabled={isLoading} className="mt-6">
        {isLoading ? <Spinner /> : 'Vybrat fotku'}
      </Button>
